"""OpenAI chat wrapper. (from langchain_community)"""
        ...
        **kwargs: Any,
        ...
        if function_call is not None:
            ...
            if isinstance(function_call, dict) and len(formatted_functions) != 1:
                raise ValueError("When specifying `function_call`, you must provide exactly one " "function.")
            if isinstance(function_call, dict) and formatted_functions[0]["name"] != function_call["name"]:
                raise ValueError(

...
def univeral_model_selector(
    ...
    **model_kwargs: Any,
    ...
    raise ValueError(
        "Could not read llm selector string. "
        "Please check [here](https://github.com/shroominic/funcchain/blob/main/MODELS.md) for more info."
    )
